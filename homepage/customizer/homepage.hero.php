	...
	new \WP_Customize_Control(
		...
		[
			...
			'choices'     => [
				...
				'blob-2'    => __( 'Blob 2', 'conversions' ),
				'blob-3'    => __( 'Blob 3', 'conversions' ),
				...
				'frame-4'   => __( 'Frame 4', 'conversions' ),
				'frame-5'   => __( 'Frame 5', 'conversions' ),
				'frame-6'   => __( 'Frame 6', 'conversions' ),
				'grunge-1'  => __( 'Grunge 1', 'conversions' ),
				'grunge-2'  => __( 'Grunge 2', 'conversions' ),
				'heart'     => __( 'Heart', 'conversions' ),
				'hexagon'   => __( 'Hexagon', 'conversions' ),
				'liquid-1'  => __( 'Liquid 1', 'conversions' ),
				'liquid-2'  => __( 'Liquid 2', 'conversions' ),
				'shatter'   => __( 'Shatter', 'conversions' ),
				'shield'    => __( 'Shield', 'conversions' ),
				'star'      => __( 'Star', 'conversions' ),
				'stripe'    => __( 'Stripe', 'conversions' ),
